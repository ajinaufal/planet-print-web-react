            ...
            <table className="table-auto w-full border-separate border-spacing-y-4">
                <thead>
                    <tr className="border border-slate-600">
                        ...
                        <th className="border-y border-l rounded-l border-black">Date</th>
                        <th className="border-y border-black">Customer</th>
                        <th className="border-y border-black">Product</th>
                        <th className="border-y border-black">Payment Status</th>
                        <th className="border-y border-black">Payment Method</th>
                        <th className="border-y border-black">Delivery Status</th>
                        <th className="border-y border-black">Amount</th>
